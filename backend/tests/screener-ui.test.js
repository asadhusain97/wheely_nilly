...
import { builtInStrategySettings } from '../src/services/strategy-settings.js';
...
it('removes the whole ticker playbook without mutating the current settings', () => {
  const settings = settingsWithTicker(builtInStrategySettings(), 'AAPL', 'cashSecuredPut', 'acquire');
